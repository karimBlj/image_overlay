...
if __name__=='__main__':
    #Jte lqisse ca la au cas ou tu veux run sur du bash. Faudra changer un peu l'interieur de la fonction mais rien de dramatique
    """
    ...
    subjects = os.listdir(dir_subjects)
    ...
    for subject in subjects:
        subject_image = cv2.imread(dir_subjects + "/" + subject)
        ...
        name_result = "Final_Output" + subject[:-4] + ".png"
